...
\begin{enumerate}[(1)]
  \item  \textbf{提出了基于惩罚变分原理的多重特征值深度学习求解框架.}该方法通过引入软边界惩罚与正交化约束克服了经典瑞利商格式失效的问题，并推导了由网络参数显式表达的总误差上界，从理论上证明了其缓解“维数灾难”的能力.

  \item  \textbf{构建了一类半线性偏微分方程的深度学习求解算法.}证明了该类非线性偏微分方程与其变分极小化问题的等价性，并在   范数下确立了非线性目标解关于样本量与网络规模的渐近收敛率.

  \item  \textbf{设计了融合 Tikhonov 正则化与深度学习的反势能问题重构算法.}该框架在算法层面改善了椭圆方程反势能问题中高度不适定性，并在理论层面证明了势函数重构误差关于观测噪声水平的渐近收敛率.
