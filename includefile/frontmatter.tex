...
\begin{enumerate}[(1)]
  ...
  \item  \textbf{构建了包含截断误差分解框架的半线性偏微分方程深度学习求解算法。}该创新针对非线性方程极小化问题建立了严格的等价性证明，并在 $H^1$ 范数下确立了非线性目标解关于样本量与网络规模的渐近收敛率。

  \item  \textbf{设计了融合 Tikhonov 正则化与深度学习的反势能问题重构算法。}该框架在算法层面有效改善了椭圆方程反势能问题中高度不适定，并在理论层面确立了势函数重构误差关于观测噪声水平的渐近收敛率。
